...
<head>
    ...
    <title>Thank You for Contacting Us! - The Dignity Draw</title>
</head>
                    ...
                    <tr>
                        <td style="padding:45px 35px;text-align:center;">
                            ...
                            <p style="margin:0 0 20px;color:#555;font-size:16px;line-height:1.8;">
                                ...
                                Thank you so much for getting in touch with us at <strong>The Dignity Draw,
                                    Inc.</strong>
                                We’ve successfully received your message and our team will get back to you as soon as
                            ...
                            <p style="margin:35px 0 0;color:#777;font-size:15px;line-height:1.7;">
                                ...
                                <strong>The Dignity Draw Team</strong> 💜
                            </p>

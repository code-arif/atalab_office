            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">
                            Stripe Settings
                            <i class="fa-solid fa-triangle-exclamation text-danger ms-1" title="Sensitive — handle with care"></i>
                        </h1>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card box-shadow-0">
                            ...
                            <div class="card-header d-flex align-items-center gap-2 border-bottom py-3">
                                <span class="avatar avatar-sm bg-primary-transparent rounded-circle me-1">
                                    <i class="fa-brands fa-stripe text-primary fs-5"></i>
                                </span>
                                <div>
                                    <h5 class="mb-0 fw-semibold">API Credentials</h5>
                                    <small class="text-muted">Your Stripe publishable key, secret key, and webhook secrets.</small>
                                </div>
                            </div>
                                ...
                                <form class="form form-horizontal" method="post"
                                    ...
                                    <div class="row mb-4 align-items-start">
                                        <label for="stripe_key" class="col-md-3 form-label fw-semibold pt-2">
                                            Stripe Key
                                            <span class="badge bg-primary-transparent text-primary ms-1 fs-10">Publishable</span>
                                        </label>
                                        <div class="col-md-9">
                                            ...
                                            @enderror
                                            <small class="text-muted">Your Stripe publishable key (starts with <code>pk_</code>).</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-start">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @error('stripe_secret')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Your Stripe secret key (starts with <code>sk_</code>). Keep this confidential.</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-start">
                                        <label for="stripe_webhook_secret" class="col-md-3 form-label fw-semibold pt-2">
                                            Webhook Secret
                                            <span class="badge bg-warning-transparent text-warning ms-1 fs-10">Webhook</span>
                                        </label>
                                        <div class="col-md-9">
                                            <div class="input-group">
                                            ...
                                            @error('stripe_webhook_secret')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Found in your Stripe Dashboard under <strong>Developers → Webhooks</strong>.</small>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card box-shadow-0">
                            ...
                            <div class="card-header d-flex align-items-center gap-2 border-bottom py-3">
                                <span class="avatar avatar-sm bg-success-transparent rounded-circle me-1">
                                    <i class="fa-solid fa-percent text-success fs-5"></i>
                                </span>
                                <div>
                                    <h5 class="mb-0 fw-semibold">Fees & Donation Configuration</h5>
                                    <small class="text-muted">Configure platform fees, Stripe processing charges, and default donation amounts.</small>
                                </div>
                            </div>

                            <div class="card-body pt-4">
                                <form class="form form-horizontal" method="post"
                                    action="{{ route('stripe.update-percentage') }}"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control @error('ach_flat_fee') is-invalid @enderror"
                                                    id="ach_flat_fee" name="ach_flat_fee"
                                            ...
                                            <small class="text-muted">Fixed flat fee applied to ACH (bank transfer) payments.</small>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control @error('card_fee_percentage') is-invalid @enderror"
                                            ...
                                            <small class="text-muted">Percentage fee charged for card payments (e.g. Stripe's 2.9%).</small>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control @error('card_fixed_fee') is-invalid @enderror"
                                                    id="card_fixed_fee" name="card_fixed_fee"
                                            ...
                                            <small class="text-muted">Fixed amount added per card transaction (e.g. Stripe's $0.30).</small>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control @error('donation_amount') is-invalid @enderror"
                                                    id="donation_amount" name="donation_amount"
                                            ...
                                            <small class="text-muted">Default or fixed donation amount per transaction.</small>
                                        </div>

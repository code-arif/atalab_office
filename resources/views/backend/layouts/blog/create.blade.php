                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                name="title" id="title" placeholder="Enter an SEO-friendly blog title..."
                                                value="{{ old('title') }}">
                                            @error('title')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            {{-- <small class="text-muted">
                                                <span class="seo-badge">SEO</span> The title will be automatically converted
                                                to a URL-friendly slug.
                                            </small> --}}
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="content" class="form-label">Content <span
                                                    class="text-danger">*</span></label>
                                            <textarea placeholder="Write your blog content here..." id="content"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                data-height="250" data-allowed-file-extensions="jpeg png jpg gif webp">
                                        ...
                                        <div class="meta-card">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <span class="badge bg-info-soft p-3 seo-badge">Improves Search
                                                    Ranking</span>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">

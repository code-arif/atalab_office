            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the content for the Archives section.</p>
                    </div>
                        ...
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Enter the title and description of the archives.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.archive.hero.section.update') }}" enctype="multipart/form-data">
                                    @csrf

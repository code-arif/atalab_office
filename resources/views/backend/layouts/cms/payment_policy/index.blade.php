...
@section('title', 'Payment Policy Page')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Payment Policy Page</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the content for the Payment Policy section.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Payment Policy Page</a></li>
                        ...
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Enter the title and full payment policy description.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.payment_policy.hero.section.update') }}" enctype="multipart/form-data">
                                    @csrf

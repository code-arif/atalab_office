...
@section('title', 'Officer Compensation Page')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Officer Compensation Page</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the content for the Officer Compensation section.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Officer Compensation Page</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    <h5 class="hero-card-title mb-0">Compensation Details</h5>
                                    <small class="text-muted">Enter the title and compensation policy description.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.officer_compensation.hero.section.update') }}" enctype="multipart/form-data">
                                    @csrf

        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Our Story Section</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the content and imagery for the Our Story section.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Story Section</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Configure the main content and preview image.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.home.our_story.section.update') }}" enctype="multipart/form-data">
                                    @csrf
...
@push('styles')
    ...
    <style>
        ...
        .dropify-wrapper {
            ...
            transition: all var(--pro-transition);
            height: 100% !important; /* Make it stretch nicely next to summernote */

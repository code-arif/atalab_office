...
@section('title', 'Percentage section')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Percentage Section</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the percentage metrics and description for your home page.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Percentage section</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Configure the main content for the percentage statistics area.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.home.percentage.section.update') }}" enctype="multipart/form-data">
                                    @csrf
...
@push('styles')
    ...
    <style>
        ...
        /* Replaces the dark theme with a clean, light, professional look */
        .editor-container {
            border-radius: var(--pro-radius-sm);
            overflow: hidden;
            border: 1.5px solid var(--pro-border);

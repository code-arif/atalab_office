...
@section('title', 'Founder Statement Section')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Founder Statement Section</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the founder's message, title, and profile image.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Founder Statement Section</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    <h5 class="hero-card-title mb-0">Header, Subtitle, Description & Image</h5>
                                    <small class="text-muted">Configure the founder's statement details.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.home.founder_statement.section.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-7 col-xl-8">
                                            ...
                                            {{-- Subtitle --}}
                                            <div class="mb-4">
                                                <label for="sub_title" class="pro-label">Subtitle</label>
                                                <input type="text" class="pro-input @error('sub_title') is-invalid @enderror"
                                        ...
                                        <div class="col-lg-5 col-xl-4">
                                            <div class="mb-4">
                                                <label for="image" class="pro-label">Founder Image</label>
                                                <input type="file"

        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Selected Name Section</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the content and imagery for the selected name section.</p>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="hero-card">
                            ...
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.home.selected_name.section.update') }}" enctype="multipart/form-data">
                                    @csrf

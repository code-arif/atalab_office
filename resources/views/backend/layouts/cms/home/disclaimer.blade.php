...
@section('title', 'Disclaimer section')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Disclaimer Section</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the disclaimer notice displayed on your home page.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Disclaimer Section</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="hero-card">
                            <div class="hero-card-header">
                                <div class="hero-card-header-icon" style="background: rgba(224, 49, 49, 0.1); color: var(--pro-danger);">
                                    <i class="fe fe-alert-circle"></i>
                                </div>
                                <div>
                                    <h5 class="hero-card-title mb-0">Disclaimer Content</h5>
                                    <small class="text-muted">Enter the title and detailed legal or informational disclaimer.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.home.disclaimer.section.update') }}" enctype="multipart/form-data">
                                    @csrf

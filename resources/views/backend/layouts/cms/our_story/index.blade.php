        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Our Story Page</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the hero section for the Our Story page.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Story Page</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Enter the main title and introduction paragraph.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.our_story.hero.section.update') }}" enctype="multipart/form-data">
                                    @csrf

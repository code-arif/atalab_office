        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">How It Works Page</h1>
                        <p class="text-muted mb-0 mt-1" style="font-size: 13px;">Manage the hero section for the How It Works page.</p>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page</a></li>
                            <li class="breadcrumb-item active" aria-current="page">How It Works Page</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="hero-card">
                            <div class="hero-card-header">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Enter the main title and introductory text.</small>
                                </div>
                            </div>
                            <div class="hero-card-body">
                                <form method="post" action="{{ route('cms.how_it_works.hero.section.update') }}" enctype="multipart/form-data">
                                    @csrf
